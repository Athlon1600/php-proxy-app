...
function et($tag){
    ...
    $zh['JSError'] = 'JavaScript错误';
    $zh['NoSel'] = '无选定项目';
    $zh['SelDir'] = '选择左侧树上的目标目录';
    $zh['TypeDir'] = ' 输入目录名 ';
    $zh['TypeArq'] = ' 输入文件名 ';
    $zh['TypeCmd'] = ' 输入命令 ';
    $zh['TypeArqComp'] = ' 输入文件名。 \\n 外延定义的压缩类型。 \\n EX： \\n nome.zip \\n nome.tar \\nnome.gzip';
    $zh['RemSel'] = ' 删除所选项目';
    $zh['NoDestDir'] = ' 没有选定的目标目录 ';
    $zh['DestEqOrig'] = ' 原点和目标目录是相等的 ';
    $zh['InvalidDest'] = ' 目标目录无效 ';
    $zh['NoNewPerm'] = ' 未设置新权限 ';
    $zh['CopyTo'] = '复制到';
    $zh['MoveTo'] = '移动到';
    $zh['AlterPermTo'] = ' 更改权限 ';
    ...
    $zh['AutoClose'] = ' 接近完成 ';
    $zh['OutDocRoot'] = ' 文件超出文件根 ';
    $zh['NoCmd'] = ' 错误：命令未通知 ';
    $zh['ConfTrySave'] = ' 文件没有写的批准。 \\n 尽量保存吗';
    $zh['ConfSaved'] = ' 配置保存 ';
    $zh['PassSaved'] = ' 密码保存 ';
    $zh['FileDirExists'] = ' 文件或目录已存在 ';
    $zh['NoPhpinfo'] = ' 函数phpinfo被禁用 ';
    $zh['NoReturn'] = '未改变';
    $zh['FileSent'] = '文件发送';
    ...
    $zh['ChkVer'] = '检查更新';
    $zh['ChkVerAvailable'] = ' 新版本，点击这里开始下载！ ';
    $zh['ChkVerNotAvailable'] = ' 没有新版本可用。 :( ';
    $zh['ChkVerError'] = ' 连接错误 ';
    $zh['Website'] = ' 网站 ';
    $zh['SendingForm'] = ' 发送文件，请稍候 ';
    $zh['NoFileSel'] = ' 没有选择的文件 ';
    $zh['SelAll'] = '全选';
    $zh['SelNone'] = '消选';
    $zh['SelInverse'] = '反选';
    $zh['Selected_s'] = ' 选出';
...
function config_form(){
    ...
    <table border=0 cellspacing=0 cellpadding=5 align=center width=\"100%\">
	<form>
    <tr><td align=right width=\"1%\">".et('Version').":<td>$version (".get_size($fm_self).")<br>（请多支持：464582835@qq.com）</td></tr>
    <tr><td align=right>".et('Website').":<td>http://phpfm.sf.net &nbsp;&nbsp;&nbsp;<input type=button value=\"".et('ChkVer')."\" onclick=\"test_config_form(1)\"></td></tr>
	</form>";
